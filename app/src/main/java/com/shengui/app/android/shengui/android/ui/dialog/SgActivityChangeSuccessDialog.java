...
public class SgActivityChangeSuccessDialog extends DialogFragment implements View.OnClickListener {

    private Context context;
    @SuppressLint("ValidFragment")
    public SgActivityChangeSuccessDialog(Context context) {
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        View view = View.inflate(getActivity(), R.layout.activity_change_success_activity, null);
