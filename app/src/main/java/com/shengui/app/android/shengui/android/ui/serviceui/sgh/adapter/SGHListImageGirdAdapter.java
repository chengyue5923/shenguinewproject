...
public class SGHListImageGirdAdapter extends RecyclerView.Adapter<SGHListImageGirdAdapter.ViewHolder> {

    List<String> data;
    Context context;
    ArrayList<String> images = new ArrayList<>();

    public SGHListImageGirdAdapter(List<String> data, Context context) {
        this.data = data;
