...
public class SgCreatePushSuccessDialog extends DialogFragment implements View.OnClickListener {

    private Context context;
    @SuppressLint("ValidFragment")
    public SgCreatePushSuccessDialog(Context context) {
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        View view = View.inflate(getActivity(), R.layout.activity_create_success_activity, null);
