...
public class SgGetRegisterSuccessDialog extends DialogFragment implements View.OnClickListener {

    private Context context;
    @SuppressLint("ValidFragment")
    public SgGetRegisterSuccessDialog(Context context) {
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        View view = View.inflate(getActivity(), R.layout.activity_register_success_activity, null);
