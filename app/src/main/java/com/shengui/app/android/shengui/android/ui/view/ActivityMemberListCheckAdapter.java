 ...
 */
public class ActivityMemberListCheckAdapter extends BasePlatAdapter<CircleMemberDetail> {
    Context mContext;
    String circleid;
    public ActivityMemberListCheckAdapter(Context context ,String crcleId) {
        super(context);
        mContext=context;
        circleid=crcleId;
    }
                ...
                public void onClick(View v) {
                    ...
                    try{
                        if(UserPreference.getTOKEN()!=null&&UserPreference.getTOKEN().length()>1){
                            ...
                            },circleid, model.getId(), UserPreference.getTOKEN());
                        }else{
