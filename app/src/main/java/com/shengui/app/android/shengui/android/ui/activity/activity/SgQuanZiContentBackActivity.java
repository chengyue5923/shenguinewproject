...
public class SgQuanZiContentBackActivity extends BaseActivity implements View.OnClickListener {
    ...
    protected void initData() {
        ...
        if (getIntent() != null) {
            models = (QuanziList) getIntent().getSerializableExtra("model");
            ...
            GuiMiController.getInstance().CircleMemberList(this, Integer.parseInt(models.getId()), 0, 5);
        }
    }

    @Override
    protected int getLayoutId() {
        return R.layout.activity_quanzi_back_activity;
    }
        ...
        if (flag == HttpConfig.Circlepprove.getType()) {
            ...
            try{
                ...
                if(json.getJSONObject("main")!=null){
                    ...
                    reservedLayout.findViewById(R.id.personInfoIvItemd).setOnClickListener(SgQuanZiContentBackActivity.this);
...
//                    }
                ...
                Logger.e("exceptionss"+e.getMessage());
            }
        }
        if(flag==HttpConfig.exitCircle.getType()){
            try {
                JSONObject object = new JSONObject(o.toString());
                if (object.getBoolean("status")) {
                    ToastTool.show("退出圈子成功");

                    Intent mIntent = new Intent();
                    mIntent.putExtra("variety_id", "1");
...
//                        IntentTools.startQuanziDetailSelf(this,models);
                        GuiMiController.getInstance().CiecleContentDetail(SgQuanZiContentBackActivity.this, Integer.parseInt(models.getId()), UserPreference.getUid());
        ...
        switch (v.getId()) {
            ...
            case R.id.exitText:
                ...
                if(UserPreference.getTOKEN()!=null&&UserPreference.getTOKEN().length()>1){
                    GuiMiController.getInstance().exitCircle(this,UserPreference.getTOKEN(),Integer.parseInt(models.getId()));
...
//                if (Integer.parseInt(models.getUser_id()) == UserPreference.getID()) {
//                    IntentTools.startJoinManage(this, models);
//                } else {
//                    IntentTools.startPublicManage(this, models);
//                }
//                IntentTools.startQuanziDetailSelf(this,models);
                break;
