 ...
 */
public class SGHMGSVideoActivity extends SGUHBaseActivity implements View.OnClickListener {
...
//                    progressVideo.setProgress(currentTime,true);
                    if (currentTime < 10) {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        if(getIntent().getSerializableExtra("topic")!=null){
            ...
            topic=(String)getIntent().getSerializableExtra("topic");
            topicid=(String)getIntent().getSerializableExtra("topicid");
            Logger.e("topic"+topicid);
        }
    ...
    public void initView() {
                ...
                if (event.getAction() == MotionEvent.ACTION_DOWN) {
                    ...
                    if (startY - event.getY() > 100) {//上移超过一定距离取消录制，删除文件
                        ...
                        if (movieRecorderView.getTimeCount() > 3) {//录制时间超过三秒，录制完成
                            ...
                            Toast.makeText(SGHMGSVideoActivity.this, "视频录制时间太短", Toast.LENGTH_SHORT).show();
                            resetData();
                        }
                    }
        ...
        movieRecorderView.setOnRecordProgressListener(new MovieRecorderView.OnRecordProgressListener() {
            ...
            public void onProgressChanged(int maxTime, int currentTime) {
                SGHMGSVideoActivity.this.currentTime = currentTime;
    ...
    private void finishActivity() {
        if (isFinish) {
            movieRecorderView.stop();
//            Intent intent = new Intent(this, SGHPutVideoActivity.class);
...
//            finish();
            ...
            chatIntent.putExtra("result",movieRecorderView.getRecordFile().getAbsolutePath());
