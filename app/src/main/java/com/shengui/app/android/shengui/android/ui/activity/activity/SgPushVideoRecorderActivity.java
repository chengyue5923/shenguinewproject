...
import com.shengui.app.android.shengui.android.base.BaseVideoActivity;
import com.shengui.app.android.shengui.android.ui.utilsview.Config;
import com.shengui.app.android.shengui.android.ui.utilsview.DateUtil;
import com.shengui.app.android.shengui.android.ui.utilsview.LogUtil;
import com.shengui.app.android.shengui.android.ui.utilsview.StringUtil;
...
public class SgPushVideoRecorderActivity  extends BaseVideoActivity implements SurfaceHolder.Callback{

    private static final String TAG = SgPushVideoRecorderActivity.class.getSimpleName();
...
//        int layoutId = mResources.getIdentifier("yuninfo_activity_video_recorder", "layout", mPackageName);
        setContentView(R.layout.yuninfo_activity_video_recorder);
...
//        mTvTimeCount = (TextView) findViewById(mResources.getIdentifier("yuninfo_tv_recorder_time_count", "id", mPackageName));
        mTvTimeCount = (TextView) findViewById(R.id.yuninfo_tv_recorder_time_count);
...
//        mButton.setBackgroundResource(mResources.getIdentifier("yuninfo_btn_video_start", "drawable", mPackageName));
        mButton.setBackgroundResource(R.drawable.yuninfo_btn_video_start);
    ...
    private void exit(final int resultCode, final Intent data) {
        if(mIsRecording) {
            new AlertDialog.Builder(SgPushVideoRecorderActivity.this)
                    .setTitle("提示")
...
//                            setResult(resultCode, data);
                            Logger.e("half-----"+mOutputFile);
                            releaseMediaRecorder();
                            releaseCamera();
                            IntentTools.startPushVideoGongqiu(SgPushVideoRecorderActivity.this,mOutputFile);
                            finish();
                        }
                    })
...
//					mTvTimeCount.setVisibility(View.INVISIBLE);
    ...
    private View.OnClickListener mOkListener = new View.OnClickListener() {
        ...
        public void onClick(View v) {
            ...
            Logger.e("ddddddddddddddd--------"+mOutputFile);
            exit(RESULT_OK, data);
...
//					lowProfile.videoFrameRate = 20 > hightProfile.videoFrameRate ? hightProfile.videoFrameRate : 20;
                ...
                if(mSupportVideoSizes != null && !mSupportVideoSizes.isEmpty()) {
                    Collections.sort(mSupportVideoSizes, new SizeComparator());
                    Camera.Size size = mSupportVideoSizes.get(0);
                    try {
