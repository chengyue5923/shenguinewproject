 ...
 */
public class ActivityMemberListMyAttentionAdapter extends BasePlatAdapter<CircleMemberDetail> {
    Context mContext;
    public ActivityMemberListMyAttentionAdapter(Context context) {
        super(context);
        mContext=context;
    }
