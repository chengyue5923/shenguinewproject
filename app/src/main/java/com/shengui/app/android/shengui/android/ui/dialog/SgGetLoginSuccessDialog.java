...
public class SgGetLoginSuccessDialog extends DialogFragment implements View.OnClickListener {

    private Context context;
    @SuppressLint("ValidFragment")
    public SgGetLoginSuccessDialog(Context context) {
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        View view = View.inflate(getActivity(), R.layout.activity_register_login_activity, null);
