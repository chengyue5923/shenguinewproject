...
public class MultipleTextViewGroup extends RelativeLayout {
    ...
    public MultipleTextViewGroup(Context context, AttributeSet attrs) {
        ...
        textColor = array.getColor(R.styleable.MultipleTextViewGroup_textColor, getResources().getColor(R.color.shenguiappcolor)); // 提供默认值，放置未指定
        ...
        textBackground = array.getResourceId(R.styleable.MultipleTextViewGroup_textBackground, getResources().getColor(R.color.white));
        //array.getc
