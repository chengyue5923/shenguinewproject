...
public class MineAddressManageActivity extends BaseActivity implements View.OnClickListener {
...
//    public void Addressadd(ViewNetCallBack callBack, String token, String name, String province_id, String city_id, String address, String mobile, String is_usual, String tel, String zipcode) {
        MineInfoController.getInstance().Addressadd(this, UserPreference.getTOKEN(),nameEvStr,provinceId,cityId,detailPhoneEvStr,phoneTVEvStr,isUsualAddress+"",phoneTVEvStr,"");
    }
    ...
    protected int getLayoutId() {
        return R.layout.activity_mine_address_manage_activity;
    }

    @Override
    public void onData(Serializable result, int flag, boolean fromNet, Object o, Map<String, Object> param) {

        if(flag== HttpConfig.Addressadd.getType()){
            try {
                JSONObject object = new JSONObject(o.toString());
                if (object.getBoolean("status")) {
                    ToastTool.show("添加地址成功");
                    finish();
                } else {
                    ToastTool.show(object.getString("message"));
                }
            } catch (Exception e) {
                ToastTool.show("添加地址失败");
            }
        }
    }
