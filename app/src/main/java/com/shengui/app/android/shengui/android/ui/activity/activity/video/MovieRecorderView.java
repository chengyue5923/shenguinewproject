...
public class MovieRecorderView extends LinearLayout implements OnErrorListener {
    ...
    public MovieRecorderView(Context context, AttributeSet attrs, int defStyle) {
        ...
        recordMaxTime = a.getInteger(R.styleable.MovieRecorderView_record_max_time, 15);//默认最大拍摄时间为10s
...
//            LogUtil.e(LOG_TAG, recordFile.getAbsolutePath());
    ...
    private void initRecord() throws Exception {
        ...
        mediaRecorder.setOutputFormat(OutputFormat.THREE_GPP);//TODO 视频输出格式 也可设为3gp等其他格式
...
//        LogUtil.e(LOG_TAG,"手机支持的最大像素supportedPictureSizes===="+sizePicture);
        if (sizePicture < 4000000) {//这里设置可以调整清晰度
            mediaRecorder.setVideoEncodingBitRate(4 * 1024 * 512);
        } else if (sizePicture <=6000000) {
