 ...
 */
public class RecordVideoGongQiuActivity extends Activity implements View.OnClickListener {
    ...
    public void initView() {
                ...
                if (event.getAction() == MotionEvent.ACTION_DOWN) {
                    ...
                    if (startY - event.getY() > 100) {//上移超过一定距离取消录制，删除文件
                        ...
                        if (movieRecorderView.getTimeCount() > 3) {//录制时间超过三秒，录制完成
                            ...
                            Toast.makeText(RecordVideoGongQiuActivity.this, "视频录制时间太短", Toast.LENGTH_SHORT).show();
                            resetData();
                        }
                    }
        ...
        movieRecorderView.setOnRecordProgressListener(new MovieRecorderView.OnRecordProgressListener() {
            ...
            public void onProgressChanged(int maxTime, int currentTime) {
                RecordVideoGongQiuActivity.this.currentTime = currentTime;
    ...
    private void finishActivity() {
        if (isFinish) {
            movieRecorderView.stop();
            Intent intent = new Intent(this, VideoPreviewGongQiuActivity.class);
