...
public class SignView extends View {
    private static final String[] WEEK_MARK = {"M", "T", "W", "T", "F", "S", "S"};
...
//        创建一个RectF，用来限定绘制圆弧的范围
        ...
        //设置画笔的颜色
        paintBackgroundHighlight.setColor(getResources().getColor(R.color.shenguiappcolor));
        //设置画笔的样式，空心
        paintBackgroundHighlight.setStyle(Paint.Style.STROKE);
        //设置抗锯齿
        paintBackgroundHighlight.setAntiAlias(true);
    ...
    public void setAdapter(SignAdapter adapter) {
