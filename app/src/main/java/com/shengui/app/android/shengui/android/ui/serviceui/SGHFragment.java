...
public class SGHFragment extends BaseFragment {
    View view;
    @Bind(R.id.viewpager)
    ViewPager viewpager;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        ThreadUtil.execute(new Runnable() {
            @Override
            public void run() {
                List<SGUViewPageBean.DataBean> dataBeen = JsonUitl.sGHspecial(getContext());
    ...
    private void initViews(List<SGUViewPageBean.DataBean> dataBeen) {
        ...
        for (int i = 0; i < dataBeen.size(); i++) {
            ...
            tvTitle.setText(dataBeen.get(i).getTitle());
            views.add(view);
        }
