...
import com.shengui.app.android.shengui.models.FansOrAttentionModel;
 ...
 */
public class ActivityMineFansListAdapter extends BasePlatAdapter<AllTypeTorModel> {
    Context mContext;
    ActivityMineNumberListAdapter adapter;
    public ActivityMineFansListAdapter(Context context) {
        super(context);
        mContext=context;
    }
    ...
    public View getView(int position, View itemView, ViewGroup parent) {
        ViewHolder vh;
        adapter=new ActivityMineNumberListAdapter(mContext);
