...
public class SgActivityPushGongQiuDialog extends DialogFragment implements View.OnClickListener {
    ...
    @SuppressLint("ValidFragment")
    public SgActivityPushGongQiuDialog(Context context) {
    ...
    private void checkCameraPermission() {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
            ...
            if (NO_VIDEO_PERMISSION.size() == 0) {
                Intent intent = new Intent(getActivity(), RecordVideoGongQiuActivity.class);
